<div class="sidebar-wrapper active">
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            @can('admin')
                <li
                    class="sidebar-item has-sub {{ Request::is('masyarakat*') ? 'active' : '' }} {{ Request::is('admin*') ? 'active' : '' }}">
                    ...
                    <ul
                        class="submenu {{ Request::is('masyarakat*') ? 'active submenu-open' : '' }} {{ Request::is('admin*') ? 'active submenu-open' : '' }}">
                        @can('admin')
