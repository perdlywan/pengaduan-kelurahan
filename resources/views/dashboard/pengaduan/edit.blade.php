                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="nik" class="form-control" placeholder="NIK"
                                                    name="nik" value="{{ $pengaduan->user->nik }}" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nama" class="form-control" placeholder="NAMA"
                                                    name="nama" value="{{ $pengaduan->user->nama }}" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('pesan') is-invalid @enderror" name="pesan" id="pesan" cols="30"
                                                    rows="5" disabled>{{ $pengaduan->pesan }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control rounded py-2 text-center"
                                                    ...
                                                    <img src="{{ asset('images/pengaduan/' . $pengaduan->foto) }}"
                                                        alt="foto" height="75" class="rounded">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control @error('tanggapan') is-invalid @enderror" name="tanggapan" id="tanggapan"
                ...
                <div class="row match-height">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form id="form-pengaduan" action="/pengaduan/{{ $pengaduan->id }}" method="POST"
                                        ...
                                        <div class="form-group mb-3">
                                            <img src="{{ asset('/images/pengaduan/' . $pengaduan->foto) }}" id="preview"
                                                class="img-thumbnail">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Pesan<sup class="text-danger">*</sup></label>
                                            <textarea id="pesan" class="form-control @error('pesan') is-invalid @enderror" name="pesan" rows="6"
                                                placeholder="Pesan">{{ old('pesan', $pengaduan->pesan) }}</textarea>
                                            @error('pesan')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
