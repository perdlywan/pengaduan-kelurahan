            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="/profile/{{ $user->id }}" method="POST"" method="POST">
                                <div class="row">
                                    @method('put')
                                    @csrf
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="nik"
                                                ...
                                                placeholder="NIK" name="nik" value="{{ old('nik', $user->nik) }}">
                                            @error('nik')
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="telp"
                                                ...
                                                placeholder="TELEPON" value="{{ old('telp', $user->telp) }}">
                                            @error('telp')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
